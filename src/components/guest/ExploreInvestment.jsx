    ...
    <div className='howitwork-content container-fit'>
        ...
        <div className='invest gap-2 flex-justify-space'>
            <div className='flex-grid left padding-2'>
                ...
                <div className='info-bullets'>
                    <p>
                    <span>&#x2713;</span> &nbsp; 
                    <strong>Highly-vetted:</strong>  All investments pass a four-step due diligence process.
                    </p>
                    <p>
                    <span>&#x2713;</span> &nbsp; 
                   <strong>Dedicated support: </strong>  Our investor relations team is available to answer your questions at any time.
                    </p>
                </div>
        ...
        <div className='earn flex-justify-space'>
            ...
            <div  className='flex-grid right'>
                ...
                <div>
                    <p>
Investments typically pay regular income, growth at maturity, or a combination of both.                    </p>
                    <p>
                    Quick payments: Your returns are deposited into your FDIC-insured Yieldstreet Wallet.                    </p>
                    <p>
...
Opportunities are evaluated first by a dedicated team for each asset class. From there, committees unassociated with the opportunity provide a fresh perspective and challenge the investment's thesis to identify any potential risks.                        </p>
                ...
                <div className='add-card'>
                    ...
                    <div className='ad-write'>
                        ...
                        Our experienced Portfolio & Risk Management Team constantly monitors your investments, providing regular updates. You can view your portfolio and track your performance at any time on the Yieldstreet app.                        </p>
